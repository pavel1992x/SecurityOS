...
print('Вас приветствует программа обновления Совет Безопасности v1.0')
os.execute('ls /mnt/')
io.write('Введите, на каком устройстве будет выполняться обновление >> ')
dev = io.read()
bin = {
...
while i < 1000 do
    ...
    break
        ...
        print('Удаляю файл ' .. bin[i])
        os.execute('rm /mnt/'..dev..'/bin/'..bin[i])
        end
        i = i + 1
    end
    ...
    while i < 1000 do
        ...
        break
            ...
            print('Удаляю файл ' .. boot[i])
            os.execute('rm /mnt/'..dev..'/boot/'..boot[i])
            end
            i = i + 1
        end
        ...
        while i < 1000 do
          if etc[i] == nil then
            ...
            print('Удаляю файл ' .. etc[i])
              os.execute('rm /mnt/'..dev..'/etc/'..etc[i])
          end
            i = i + 1
        end
        ...
        while i < 1000 do
          if lib[i] == nil then
            ...
            print('Удаляю файл ' .. lib[i])
              os.execute('rm /mnt/'..dev..'/lib/'..lib[i])
          end
            i = i + 1
        end
        ...
        while i < 1000 do
          if lib0core[i] == nil then
            ...
            print('Удаляю файл ' .. lib0core[i])
              os.execute('rm /mnt/'..dev..'/lib/core/'..lib0core[i])
          end
            i = i + 1
        end
        ...
        while i < 1000 do
          if lib0core0devfs[i] == nil then
            ...
            print('Удаляю файл ' .. lib0core0devfs[i])
              os.execute('rm /mnt/'..dev..'/lib/core/devfs/'..lib0core0devfs[i])
          end
            i = i + 1
        end
        ...
        while i < 1000 do
          if lib0core0devfs0adapters[i] == nil then
            ...
            print('Удаляю файл ' .. lib0core0devfs0adapters[i])
              os.execute('rm /mnt/'..dev..'/lib/core/devfs/adapters/'..lib0core0devfs0adapters[i])
          end
            i = i + 1
        end
        ...
        while i < 1000 do
          if lib0tools[i] == nil then
            ...
            print('Удаляю файл ' .. lib0tools[i])
              os.execute('rm /mnt/'..dev..'/lib/tools/'.. lib0tools[i])
          end
            i = i + 1
        end
